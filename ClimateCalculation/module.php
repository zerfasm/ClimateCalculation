...
class ClimateCalculation extends IPSModule
{
	...
	//Zeit Fenster Offen
        ...
        $this->MaintainVariable('TimeWinOpen', 'Zeit Fenster geöffnet', vtString, '', 14, $create);    
	...
	if ($wv != 0) 
	{
		...
		else
		{
			...
			$timeopen = (GetValue($this->ReadPropertyInteger('WinClose')) - GetValue($this->ReadPropertyInteger('WinOpen')));
